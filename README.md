# Fitness product research and plans

Working home for the fitness education and coaching product idea. Product decisions here are hypotheses until tested with customers.
...
- [Source ledger](research/2026-09-13-reddit-evidence.csv): 32 retained Reddit discussions, two supplemental removed posts, and five exclusions. Each entry records what was actually visible and separates spending from stated interest.
- [Validation plan](plans/first-month-gym-pilot.md): interviews, usability checks, a paid pilot, and criteria for proceeding.
...
The strongest recurring need in the earlier Reddit research was reducing uncertainty while taking action. Free programs, lessons, and AI workout apps already exist. The unproven business opportunity is delivering a better transition from confused beginner to confident participant, with support people will pay for.

The original `Gym Foundations — Business Plan.pdf` is retained as background. The newer research refines the proposed product; it does not establish market size or validate revenue projections.
